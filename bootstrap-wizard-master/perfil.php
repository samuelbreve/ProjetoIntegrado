    ...
    <div class="container">
        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="wizard-container">
                ...
                <form action="../cadPosto.php" method="POST">
                  <?PHP
                  include_once("../backend/conexao.php");
                    // $query = "select * from cliente where id = ".mysqli_insert_id($conn)."";
                    $query = "select gasolina from cliente where id = 1";
                ...
                <!--        You can switch ' data-color="green" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
                    	...
                    	<div class="wizard-header">
                        	<h3>
                        	   <b>Seu Posto </b> <br>
                        	   <small>Atualize o preço de seu combustível diariamente.</small>
                        	</h3>
                    	</div>
						<div class="wizard-navigation">
							             <ul>
	                            <li><a href="#location" data-toggle="tab">Combustível</a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="location">
                              <div class="row">
                                  <div class="col-sm-12">
                                    <h4 class="info-text"> Combustíveis</h4>
                                  </div>
                                  <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                        <label>Gasolina</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="R$" name="gasolina" value="
                                        <?PHP
                                          // $query = "select estado from cliente where id = 1";
                                          // $result = mysqli_query($conn, $query);
                                          // $row = mysqli_fetch_array($result, MYSQLI_NUM);
                                          print_r($row);
                                        ?>
                                  ...
                                  <div class="col-sm-5">
                                      <div class="form-group">
                                        <label>Gasolina Aditivada</label><br>
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="R$" name="gasolinaAditivada">
                                      </div>
                                  </div>
                                  <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                        <label>Etanol</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="R$" name="etanol">
                                      </div>
                                  </div>
                                  <div class="col-sm-5">
                                      <div class="form-group">
                                        <label>Diesel</label><br>
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="R$" name="diesel">
                                      </div>
                                  </div>
                              </div>
                            </div>
                            <div class="tab-pane" id="type">
                                <h4 class="info-text">Meus dados</h4>
                                <div class="row">
                                    <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                  ...
                                  <div class="col-sm-5 col-sm-offset-1">
                                         <div class="form-group">
                                          <label>Usuário</label>
                                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Usuário">
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                         <div class="form-group">
                                          <label>Senha</label>
                                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Senha">
                                        </div>
                                    </div>
                              </div>
                            </div>
                        ...
                        <div class="wizard-footer">
                            	<div class="pull-right">
                                    ...
                                    <input type='submit' class='btn btn-finish btn-fill btn-success btn-wd btn-sm' name='finish' value='Atualizar' />
